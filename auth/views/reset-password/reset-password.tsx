...
import { resetPassword } from "@/auth/api/actions";
...
export const ResetPassword = ({ token }: { token: string }) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        resetPassword({
            ...
            .then(() => {
                router.push(FRONTEND_URLS.DASHBOARD);
            })
            .catch(() => {
    ...
    return (
        <div className="z-20 flex aspect-square flex-col items-center justify-center">
            ...
            <div className={"z-20 mb-16 pt-5 text-[30px] font-medium leading-[36px]"}>Choose a New Password</div>
            <div className="z-20 w-[440px] rounded-3xl bg-white p-[40px] pt-[32px] shadow-md">
                {loading ? (
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label htmlFor="confirm_password" className="mb-[6px] block text-[14px] font-medium leading-[19px] text-gray-600">
                                Confirm Password
                            </label>
                            <input
                                type="password"
